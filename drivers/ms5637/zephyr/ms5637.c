...
#define MS5637_CONV_TIMER_OSR8192_MS 17
#define MS5637_CONV_TIMER_OSR4096_MS 9
#define MS5637_CONV_TIMER_OSR2048_MS 5
#define MS5637_CONV_TIMER_OSR1024_MS 3
#define MS5637_CONV_TIMER_OSR512_MS 2
#define MS5637_CONV_TIMER_OSR256_MS 1
...
static int32_t calc_pressure(const struct device *dev, uint32_t value)
{
	...
	offs = (data->off_t1 << 17) + ((data->tco * data->dt) >> 6);
	sens = (data->sens_t1 << 16) + ((data->tcs * data->dt) >> 7);
	press = (((value * sens) >> 21) - offs) >> 15;
	return press;
}
